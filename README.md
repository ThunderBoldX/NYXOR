...
| 🔥 Відстеження Watch Streak | Експериментально |
| 🎭 Перехід за рейдами без переривання Drops | Експериментально |
| 🎬 Автоматичний claim Moments | Експериментально |
| 🔮 Predictions з обмеженням ставки | Експериментально, вимкнено за замовчуванням |
...
NYXOR поширюється за ліцензією [MIT](LICENSE). Частина коду створена на основі MIT-компонентів; подробиці наведені в [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md).
